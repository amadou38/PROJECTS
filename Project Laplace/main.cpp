...
int main(int argc, char* argv[])
{
  ...
  Mesh m;
  readMsh(m, "benchmark/DOM/dom3x545x8.msh");
  ...
  saveSol(p.U, "benchmark/solNum3x545x8.msh");
  saveSol(Uex, "benchmark/solExa3x545x8.msh");
  saveSol(uErr, "benchmark/solErr3x545x8.msh");
